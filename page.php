...
<head>
<title>BlogStarter - Demo Page</title>
...
<!-- BEGIN wrapper -->
<div id="wrapper">
  <p class="rss"> <a href="http://all-free-download.com/free-website-templates/">Posts</a> | <a href="http://all-free-download.com/free-website-templates/">Comments</a> | <a href="http://all-free-download.com/free-website-templates/">Email</a> </p>
  <!-- BEGIN header -->
  <div id="header">
    <h1><a href="http://all-free-download.com/free-website-templates/">BlogStarter</a></h1>
    <div class="ad"> <a href="http://all-free-download.com/free-website-templates/"><img src="files/ad468x60.gif" alt="" /></a> </div>
    <div class="break"></div>
    <ul>
      <li><a href="index.php">Home</a></li>
      <li><a href="about.php">About us</a></li>
      <li><a href="page.php">Demo Page</a></li>
  ...
  <div id="body">
    ...
    <div id="content">
      <!-- begin post -->
      <div class="single">
        <h2>Pellentesque Aapien Orci Blandit</h2>
        <div class="break"></div>
        ...
        <p><img class="alignright" src="files/200x150.gif" width="200" height="150" alt="" /></p>
        ...
        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Curabitur quam augue, vehicula quis, tincidunt vel, varius vitae, nulla. Sed convallis orci. Duis libero orci, pretium a, <a href="http://all-free-download.com/free-website-templates/">convallis quis</a>, pellentesque a, dolor. Curabitur vitae nisi non dolor vestibulum consequat.</p>
        ...
        <p><cite><a href="http://all-free-download.com/free-website-templates/">Quote Source</a></cite></p>
    ...
    <div id="sidebar">
      ...
      <h2>Sponsors</h2>
      <div class="break"></div>
      <a href="http://all-free-download.com/free-website-templates/"><img src="files/ad125x125.jpg" alt="" /></a> <a href="http://all-free-download.com/free-website-templates/"><img src="files/ad125x125.jpg" alt="" /></a> <a class="sponsors" href="http://all-free-download.com/free-website-templates/"><img src="files/ad125x125.jpg" alt="" /></a> <a class="sponsors" href="http://all-free-download.com/free-website-templates/"><img src="files/ad125x125.jpg" alt="" /></a>
      <!-- end sponsors -->
      <!-- begin search -->
      ...
      <div class="pop">
        ...
        <div class="break"></div>
        <ul>
          <li> <a class="title" href="http://all-free-download.com/free-website-templates/">Top 10 Ways to Make Money Online</a>
            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse interdum..</p>
          </li>
          <li> <a class="title" href="http://all-free-download.com/free-website-templates/">The Basics of Photography and Choosing the Right Subject</a>
            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse interdum..</p>
          </li>
          <li> <a class="title" href="http://all-free-download.com/free-website-templates/">How to Create Wordpress Themes from Scratch and Selling them Online</a>
            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse interdum..</p>
          </li>
        </ul>
        <div class="break"></div>
      ...
      <div class="video">
        ...
        <div class="break"></div>
        <img src="files/video.jpg" alt="" /> </div>
      <!-- end featured video -->
      <!-- begin tagcloud -->
      <div class="tag">
        <h2>Tagcloud</h2>
        <div class="break"></div>
        <div class="tagcloud"><img src="files/tagcloud.gif" alt="" /></div>
        <div class="break"></div>
      </div>
      <!-- end tagcloud -->
      <!-- begin categories -->
      ...
      <div class="archive">
        ...
        <div class="break"></div>
        <ul>
          <li><a href="http://all-free-download.com/free-website-templates/">January 2009</a></li>
          ...
          <li><a href="http://all-free-download.com/free-website-templates/">July 2009</a></li>
      ...
      <div class="meta">
        ...
        <ul>
          ...
          <li><a href="http://all-free-download.com/free-website-templates/">Valid XHTML</a></li>
        </ul>
        <div class="break"></div>
      </div>
      <!-- end meta -->
  ...
  <!-- BEGIN footer -->
  <div id="footer">
    <p>Copyright &copy; 2009 - <a href="http://all-free-download.com/free-website-templates/">Website Name</a> &middot; All Rights Reserved | Template by: <a href="http://www.wpthemedesigner.com/">WordPress Designer</a> | Get More <a href="http://all-free-download.com/free-website-templates/">Free CSS Templates</a></p>
  </div>
  <!-- END footer -->
</div>
<!-- END wrapper -->
