	...
	<div class="module">
		...
		<div class="module-table-body">
			...
			<table id="myTable" class="tablesorter">
				...
				<tbody>
				<?php
					$query="SELECT news.*,category.name as cname FROM news 
							INNER JOIN category
					...
					while ($arItem=mysqli_fetch_array($result)) {
						...
						<tr>
							...
							<?php
									...
									?>
							<td align="center">
								<a href="editNews.php?id=<?=$id_news?>">Sửa <img src="/templates/admin/images/pencil.gif" alt="edit"/></a>
								<a href="delNews.php?id=<?=$id_news?>">Xóa <img src="/templates/admin/images/bin.gif" width="16" height="16"
													alt="delete"/></a>
							</td>
						</tr>
							<?php
		 ...
		 <div class="pagination">           
            ...
            for ($i=1;$i<=$sotrang;$i++)
            {
                ...
                ?>
				<a href="indexNews.php?page=<?=$i?>"<?=$activepage?>><?=$i?></a>
				<span>|</span>
                <?php
            }
            ?>
